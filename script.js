...
$(document).ready(() => {
 ...
 code.innerHTML="get code !"
  ...
  newImgone = document.createElement('img')
  newh3.append(document.createTextNode(`you need subscribe `+` ♦♦`+` to continu ♦♦`))
  nnewDiv.style=`
  position:relative;
  margin-block:-199%; margin-left:;background-color:black;width:99%;height:100%;
  border:double;border-color:black;
  z-index:100; 
  opacity:;
  ...
  `
  newh3.style=`
  margin-block:95%; padding-left:5%; margin-block:; margin-left:23%;background-color:green;width:50%;
 
  `
 newImgone.src="img/20 0.webp"
 newImgone.style=`
  margin-button:0%; margin-block:90%; padding-left:10%;  margin-left:14%;width:50%;
 `
  
  nnewDiv.setAttribute("onclick","subsc()")
  a = document.createElement("a")
  a.setAttribute("href","https://youtube.com/@bot-app-master?si=CnEgz7abwNUIvgpK")
  nnewDiv.append(newImgone)
  a.append(nnewDiv)
  // newDiv.append(newh3)
  body.append(a)
  }

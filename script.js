...
$(document).ready(() => {
 ...
 code.innerHTML="get code !"
  ...
  newh3.append(document.createTextNode(`"مرحبًا! 🤩 إذا كنت ترغب في الحصول على كلمة المرور الحصرية لموقعنا 🤫، لا تنسى متابعة حسابنا على انستقرام! 📸 سنقوم بنشر الكلمة السرية في قصصتنا، لذا تأكد من أنك تتابعنا للحصول على هذه الفرصة الفريدة! 💥 لا تفوت فرصة الحصول على كلمة المرور الحصرية! 🔓 متابعة حسابنا الآن وكن من بين الأوائل الذين يحصلون على الكلمة السرية! 🚀 #كلمة_المرور #متابعة #انستقرام #فرصة_فريدة"`))
  nnewDiv.style=`
  position:relative;
  margin-block:-290%; margin-left:;background-color:black;width:100%;height:100%;
  border:double;border-color:black;
  z-index:100; 
  opacity:;
  ...
  `
  newh3.style=`
 height:100%; margin-block:155%;margin-left:15%;background-color:;width:70%;
